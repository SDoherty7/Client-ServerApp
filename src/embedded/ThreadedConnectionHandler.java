/* The Connection Handler Class is heavily expanded upon the sample written by Derek Molloy 
...
public class ThreadedConnectionHandler extends Thread
{
    ...
    public ThreadedConnectionHandler(Socket clientSocket) {
        ...
        //Set up a service object to get the current date and time and the temperature
    ...
    private void getDate() {	// use the date service to get the date
        ...
        int currentTemp = theDateService.getTempReadings();
        //Send DateTimeService object to the client which includes temperature readings and a time stamp
        DateTimeService serverInfo = new DateTimeService(currentDateTimeText, currentTemp);
