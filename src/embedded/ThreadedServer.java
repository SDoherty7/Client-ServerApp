/* The Threaded Server Class is expanded upon the sample written by Derek Molloy 
...
public class ThreadedServer 
{
	...
	public static void main(String args[]) {
        ...
        while (listening) // almost infinite loop - loop once for each client request
        {
            ...
            //Create a new thread so the server can continue listening for other connections
